...
export default function Contact({ language }: ContactProps) {
  ...
  return (
    <section id="contact-section" className="py-16 sm:py-24 bg-slate-50/50 border-t border-slate-200 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
            <motion.div 
              ...
              className="space-y-6"
            >
              <h3 className="text-xl font-bold font-serif text-slate-800 border-b border-slate-100 pb-4">
                {language === 'en' ? 'Saubhagya Hospital Raipur' : 'सौभाग्य हॉस्पिटल रायपुर'}
              </h3>

              {/* Phone item */}
              <motion.div whileHover={{ x: 5 }} className="flex items-start gap-4">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-teal-50 text-teal-600 border border-teal-100 shadow-xs">
                  <Phone className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider">{t.contactPhone}</h4>
                  <p className="text-base font-bold text-slate-900 mt-1 font-sans">
              ...
              {/* Address item */}
              <motion.div whileHover={{ x: 5 }} className="flex items-start gap-4">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600 border border-indigo-100 shadow-xs">
                  <MapPin className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider">{t.contactAddress}</h4>
                  <p className="text-sm sm:text-base font-semibold text-slate-800 mt-1 leading-relaxed font-sans">
              ...
              {/* Hours item */}
              <motion.div whileHover={{ x: 5 }} className="flex items-start gap-4">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-100 shadow-xs">
                  <Clock className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider">{t.contactHours}</h4>
                  <p className="text-sm sm:text-base font-bold text-slate-800 mt-1 font-sans">
                    {t.contactHoursVal}
                  </p>
                  <p className="text-xs text-slate-500 mt-0.5 font-sans">
              ...
              {/* Email item */}
              <motion.div whileHover={{ x: 5 }} className="flex items-start gap-4">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-blue-50 text-blue-600 border border-blue-100 shadow-xs">
                  <Mail className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider">{t.contactEmail}</h4>
                  <p className="text-sm sm:text-base font-semibold text-slate-700 mt-1 font-sans">
            ...
            <motion.div 
              ...
              className="p-4 rounded-2xl border border-rose-100 bg-rose-50/50 text-rose-800 text-xs sm:text-sm flex gap-3 mt-6 cursor-default"
            >
          ...
          >
            <motion.div 
              ...
              className="rounded-3xl border border-slate-200 bg-white p-4 shadow-md h-full flex flex-col justify-between transition-all duration-300"
            >
              <div>
                <div className="flex items-center justify-between mb-4 px-2">
                  <h4 className="font-bold text-slate-800 text-sm tracking-wide uppercase flex items-center gap-1.5 font-serif">
                ...
                <div id="google-map-container" className="relative w-full h-[320px] rounded-2xl overflow-hidden border border-slate-200 shadow-inner">
                  {/* Map Iframe */}
                  <iframe
              ...
              <div className="mt-4 pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                <span className="text-xs text-slate-400 leading-normal text-center sm:text-left font-sans font-medium">
                  {language === 'en' 
