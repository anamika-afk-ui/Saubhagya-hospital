...
export default function Testimonials({ language }: TestimonialsProps) {
  ...
  return (
    <section id="reviews-section" className="py-16 sm:py-24 bg-white border-t border-slate-200 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 mb-10 border-b border-slate-200 pb-8">
          ...
          <motion.div 
            ...
            className="flex items-center gap-4 bg-blue-50/40 border border-blue-100 p-4 rounded-2xl w-fit cursor-default"
          >
            ...
            <div>
              <div className="flex gap-1 mb-1">
                {[1, 2, 3, 4, 5].map((s) => (
                  <Star key={s} className="h-4 w-4 fill-amber-400 text-amber-400 animate-pulse" />
                ))}
              </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            {tags.map((tag) => (
              <motion.button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold tracking-wide transition cursor-pointer relative ${
                  selectedTag === tag 
          ...
          <motion.button
            ...
            className="px-5 py-2.5 rounded-xl border border-blue-200 bg-blue-50 text-blue-700 font-bold text-xs sm:text-sm hover:bg-blue-100 transition cursor-pointer flex items-center gap-2 self-start lg:self-auto shadow-xs"
          >
        ...
        {/* Submit Review Dialog (Conditional Expansion with Smooth SlideDown Accordion) */}
        <AnimatePresence>
          {showForm && (
            <motion.div 
              ...
              className="mb-12 overflow-hidden rounded-2xl border border-blue-100 bg-blue-50/15 max-w-2xl mx-auto"
            >
              <div className="p-6 sm:p-8">
                ...
                {formSuccess ? (
                  <motion.div 
                    ...
                    className="p-4 rounded-xl bg-emerald-50 border border-emerald-100 text-emerald-800 text-sm flex items-center gap-2"
                  >
                  ...
                  <form onSubmit={handleAddReview} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-slate-200 bg-white p-3 text-sm focus:border-blue-600 focus:outline-hidden text-slate-800"
                        />
                      </div>
                      <div>
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="px-5 py-2 text-xs font-bold text-white bg-blue-600 rounded-xl hover:bg-blue-700 cursor-pointer shadow-xs"
                      >
            ...
            {filteredReviews.length === 0 ? (
              ...
              filteredReviews.map((rev, index) => (
                <motion.div 
                  ...
                  className="p-6 rounded-2xl border border-slate-200 bg-white hover:border-blue-200 transition-all duration-300 flex flex-col justify-between cursor-default"
                >
                  <div>
